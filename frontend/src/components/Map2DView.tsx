...
export const Map2DView: React.FC<Map2DViewProps> = ({
  ...
  return (
    <div 
      ref={containerRef}
      className="flex-1 flex flex-col bg-space-950 text-slate-100 font-mono relative overflow-hidden rounded-2xl border border-space-800 shadow-2xl min-h-[calc(100vh-115px)] h-[calc(100vh-115px)]"
    >
