...
STARLINK_1 = OrbitalObject(
    id=1, norad_id=44713, name="STARLINK-1007", object_type=ObjectType.SATELLITE,
...
STARLINK_2 = OrbitalObject(
    id=2, norad_id=44725, name="STARLINK-1019", object_type=ObjectType.SATELLITE,
    tle_line1="1 44725U 19074N   26236.32000000  .00001250  00000+0  88000-4 0  9992",
    tle_line2="2 44725  53.0540 110.5120 0001435  81.4500 279.1200 15.06440000341501",
    perigee_km=546.0, apogee_km=554.0
)

GEO_SAT = OrbitalObject(
    id=3, norad_id=99999, name="GEO-TEST", object_type=ObjectType.SATELLITE,
...
def test_conjunction_detection_and_tca():
    ...
    events = ConjunctionService.find_tca_between_objects(
        STARLINK_1, STARLINK_2, start, end, coarse_step_minutes=5, threshold_km=50.0
    )
    
    # Co-planar Starlink constellation objects in adjacent slots maintain close orbital geometry
